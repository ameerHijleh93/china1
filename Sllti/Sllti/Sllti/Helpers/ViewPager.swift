...
//  sibghatWafa
//
//  Created by Heema Boss on 5/6/18.
...
public class ViewPager: UIView {
    ...
    func setupPageControl() {
        ...
        self.pageControl.pageIndicatorTintColor = UIColor.lightText
...
extension ViewPager{
    ...
    func animationNext(){
        Timer.scheduledTimer(timeInterval: 3, target: self, selector: #selector(ViewPager.moveToNextPage), userInfo: nil, repeats: true)
    }
